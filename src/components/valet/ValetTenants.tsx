...
const inp: React.CSSProperties = { background: '#fff', color: '#1E1B17', WebkitTextFillColor: '#1E1B17', width: '100%', boxSizing: 'border-box', border: '1px solid #D1D5DB', borderRadius: 10, padding: '11px 12px', fontSize: 16, outline: 'none' }
